...
import config
from data_reader import create_dataset,create_dataset_singleLine, max_length, save_word_dict
...
def train(train_path='', model_dir='', save_src_vocab_path='', save_trg_vocab_path='', embedding_dim=256,
    ...
    source_texts, target_texts = create_dataset(train_path, 10)#create_dataset_singleLine(train_path, None)
